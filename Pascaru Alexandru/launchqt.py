...
class Window(QWidget):
    ...
    def createGridLayout(self):
        ...
        buttonCSN = QPushButton("CREATE GPU", self)
        buttonCSN.clicked.connect(csn)
        gridLayout.addWidget(buttonCSN, 4,1)
        
        buttonADD = QPushButton("ADD GPU TO STOCK", self)
        ...
        buttonSELgpu = QPushButton("SELECT FROM GPU", self)
        buttonSELgpu.clicked.connect(selgpu)
        gridLayout.addWidget(buttonSELgpu, 7,1)
